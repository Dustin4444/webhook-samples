...
```bash title="Install Vercel CLI with pnpm"
pnpm i vercel
```

```bash title="Install Vercel CLI with yarn"
yarn i vercel
```

```bash title="Install Vercel CLI with npm"
npm i vercel
```

```bash title="Install Vercel CLI with bun"
bun i vercel
```
...
```tsx title="src/layouts/Base.astro"
---
...
```jsx title="src/layouts/Base.astro"
---
import Analytics from '@vercel/analytics/astro';
{/* ... */}
---
